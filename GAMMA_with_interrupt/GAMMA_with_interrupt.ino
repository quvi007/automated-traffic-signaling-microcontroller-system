...
const int INT_PIN1 = 2;
const int INT_PIN2 = 18; 
const int INT_PIN3 = 19;  


const int average_car_length = 5;

volatile int active_road = 1;
...
void setup(){
  ...
  attachInterrupt(digitalPinToInterrupt(INT_PIN1),ISR_button1, CHANGE) ;
  pinMode(INT_PIN2, INPUT) ;
  attachInterrupt(digitalPinToInterrupt(INT_PIN2),ISR_button2, CHANGE) ;
  pinMode(INT_PIN3, INPUT) ;
  attachInterrupt(digitalPinToInterrupt(INT_PIN3),ISR_button3, CHANGE) ;
}
...
void ISR_button1(){
  //Serial.print("111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111");
  long now = millis() ;
  if( active_road == 1 ) lane1.timer = now;
  else if( active_road == 3) lane3.timer = now;
  else lane5.timer = now ;
  active_road = 3; 
  lane3.timer = now ;
}
